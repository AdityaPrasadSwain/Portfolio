...
export default function Testimonials() {
 ...
 <h2 className="text-4xl font-medium mt-2 text-white">What People Say</h2>
 </motion.div>
 ...
 <div className="w-12 h-12 rounded-full bg-gradient-to-tr from-primary to-secondary flex items-center justify-center text-white font-medium text-lg">
 {t.name[0]}
 </div>
 <div>
