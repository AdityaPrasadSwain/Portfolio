...
const projectImages = {
  ...
  "Expense Management System": "/images/financial_metrics_visualization_1772658522572.png",
  "Event Management System": "/images/event_types_gallery_visual_1772658217207.png"
};
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 mb-16">
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-6">
                ...
                <span className="text-[10px] font-mono font-medium text-white/20 uppercase tracking-widest">Scroll to explore</span>
              </div>
            </div>

            <div className="flex items-center gap-4">
              <button onClick={scrollLeft} className="w-14 h-14 rounded-2xl glass-main border border-white/5 flex items-center justify-center text-white/30 hover:text-primary hover:border-primary/20 hover:bg-primary/5 transition-all group/nav">
                <ArrowRight className="rotate-180 group-hover/nav:-translate-x-1 transition-transform" size={20} />
              </button>
              <button onClick={scrollRight} className="w-14 h-14 rounded-2xl glass-main border border-white/5 flex items-center justify-center text-white/30 hover:text-primary hover:border-primary/20 hover:bg-primary/5 transition-all group/nav">
          ...
          <div className="relative group/gallery">
            <div ref={scrollContainerRef} className="overflow-x-auto no-scrollbar pb-12 snap-x snap-mandatory scroll-smooth flex gap-8 lg:gap-12 px-2">
                ...
                >
                  ...
                  <div className="absolute inset-0 z-20 p-8 flex flex-col justify-between">
                    <div className="flex justify-between items-start">
                      <span className="text-[10px] font-mono font-medium text-primary uppercase tracking-[0.3em] bg-primary/10 px-4 py-1.5 rounded-full border border-primary/20">
                        0{index + 1}
                      </span>
                      <div className="hidden group-hover/card:flex items-center gap-2">
                        <div className="w-2 h-2 rounded-full bg-primary animate-pulse" />
                        <span className="text-[10px] font-mono font-semibold text-white/50 uppercase tracking-widest leading-none">View System</span>
                      </div>
                    </div>

                    <div>
                      <p className="text-[10px] font-mono font-medium text-white/30 uppercase tracking-[0.4em] mb-3">{project.category}</p>
                      <h3 className="text-2xl md:text-3xl font-display font-semibold text-white tracking-normal uppercase leading-tight mb-4 group-hover:translate-x-2 transition-transform duration-700">
                        {project.title}
                      </h3>
                  ...
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-30 opacity-0 group-hover/card:opacity-100 transition-all duration-500 scale-50 group-hover/card:scale-100 pointer-events-none">
                    <div className="w-24 h-24 rounded-full bg-primary flex items-center justify-center text-black font-semibold uppercase text-[10px] tracking-widest shadow-neon-cobalt rotate-6">
                      Open<br />Case
                    </div>
                  </div>
                </motion.div>
            ...
            >
              ...
              <div className="lg:w-[45%] bg-surface relative overflow-hidden hidden lg:block">
                ...
                <div className="absolute bottom-16 left-16 right-16 z-20">
                  <h4 className="text-[10px] font-mono font-semibold text-primary uppercase tracking-[0.5em] mb-6">System Visualization</h4>
                  <div className="p-1 glass-card-premium rounded-[2rem] border border-white/10">
                    <img
                      src={selectedProject.supplementaryImage || "/images/system_architect_visual_1772640355787.png"}
                      alt="Architecture"
                      className="w-full rounded-[1.8rem] opacity-80"
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="flex-1 p-10 md:p-20 overflow-y-auto custom-scrollbar">
                <div className="max-w-xl">
                  <div className="flex items-center gap-4 mb-10">
                    <span className="px-4 py-1.5 bg-secondary/20 text-secondary rounded-full text-[10px] font-mono font-medium uppercase tracking-widest border border-secondary/20">{selectedProject.category}</span>
                    <span className="w-12 h-[1px] bg-white/10" />
                    <span className="text-[10px] font-mono font-medium text-white/40 uppercase tracking-widest">Case Study 2024</span>
                  </div>

                  <h2 className="text-4xl md:text-6xl font-display font-semibold text-white tracking-normal leading-none uppercase mb-12">
                    {selectedProject.title}
                  </h2>

                  <div className="space-y-16 mb-20">
                    <div>
                      <h4 className="text-primary font-mono font-semibold uppercase tracking-[0.4em] text-[10px] mb-6">The High-Level Concept</h4>
                      <p className="text-textSoft text-xl font-light leading-relaxed ">
                    ...
                    <div className="p-10 bg-white/[0.02] border border-white/5 rounded-[2.5rem]">
                      <h4 className="text-white font-mono font-semibold uppercase tracking-[0.4em] text-[10px] mb-6">Critical Challenges</h4>
